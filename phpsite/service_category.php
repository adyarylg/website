...
// Now reads from the new, simpler array in data.php
if (!isset($service_category_info[$category_slug])) {
    header("Location: services.php");
    exit();
}

$category = $service_category_info[$category_slug];
...
// Load content from the new markdown files
...
// Load prices from the new JSON file
$prices_data = null;
...
<section class="relative h-[40vh] bg-cover bg-center" style="background-image: url('<?php echo $images['categories'][$category_slug]; ?>');">
    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
        <div class="text-center text-white p-4">
            <h1 class="text-5xl md:text-6xl font-playfair font-bold"><?php echo $category['name']; ?></h1>
        </div>
    </div>
</section>
...
<div class="container mx-auto px-6 py-20">
    <div class="grid lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-2">
            ...
            <?php if ($prices_data && isset($prices_data['sections'])): ?>
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-6">
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between items-center border-b border-gray-200 py-4">
                                ...
                                <p class="text-lg font-bold text-ylg-pink whitespace-nowrap pl-4">₹<?php echo htmlspecialchars($service['price']); ?></p>
                            </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
        ...
        <div class="lg:col-span-1">
            <div class="sticky top-28">
                <div class="bg-white rounded-lg shadow-xl p-8 text-center">
                    ...
                    <p class="text-gray-600 mb-6">Book your <?php echo strtolower($category['name']); ?> appointment online now. It's fast, easy, and secure.</p>
